...
**Download Spotifast:** [Mac](https://github.com/crmne/spotifast/releases/download/v0.10.0/spotifast-v0.10.0-macos-universal.dmg) · [Windows](https://github.com/crmne/spotifast/releases/download/v0.10.0/spotifast-v0.10.0-x86_64-pc-windows-msvc-setup.exe) · [Windows ARM](https://github.com/crmne/spotifast/releases/download/v0.10.0/spotifast-v0.10.0-aarch64-pc-windows-msvc-setup.exe) · [Linux](https://github.com/crmne/spotifast/releases/download/v0.10.0/spotifast-v0.10.0-x86_64-unknown-linux-gnu.tar.gz) · [Linux ARM](https://github.com/crmne/spotifast/releases/download/v0.10.0/spotifast-v0.10.0-aarch64-unknown-linux-gnu.tar.gz) · [Flatpak](https://github.com/crmne/spotifast/releases/download/v0.10.0/spotifast-v0.10.0-x86_64.flatpak)

![Spotifast with the playlist library, queue, and player](https://raw.githubusercontent.com/crmne/spotifast/v0.10.0/docs/screenshot.png)
...
**Full changelog**: https://github.com/crmne/spotifast/compare/v0.9.1...v0.10.0
